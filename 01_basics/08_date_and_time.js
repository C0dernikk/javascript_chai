...
console.table([myDate.toISOString(), myDate.toJSON(), myDate.toLocaleDateString(), myDate.toLocaleString(), myDate.toLocaleTimeString(), myDate.toTimeString(),myDate.getTimezoneOffset()]);
...
let createdDate2 = new Date("01-01-2004")
